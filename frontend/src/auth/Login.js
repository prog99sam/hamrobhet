...
const TRUST_ITEMS = [
  'Secure Google login, no new passwords',
  'Nothing to remember, ever',
  'Cancel your support anytime',
];
      ...
      <div className="left">
        ...
        <div className="left-mid">
          ...
          <h1 className="headline">
            Support Nepali<br />
            <span className="accent">creators</span> directly
          </h1>
          <p className="description">
            Join a growing platform where fans directly support the artists, educators, musicians, and builders shaping Nepal's creative future — one monthly contribution at a time.
          </p>
          ...
          <div className="stats-row">
            ...
            <div>
              <div className="stat-num">रू</div>
              <div className="stat-label">Built for Nepal</div>
            </div>
          </div>
        ...
        <div className="left-bottom">
          <div className="left-tagline">
            ...
            A new way to support creativity in Nepal
          </div>
        </div>
      </div>
      ...
      <div className="right">
        <div className="card">
          ...
          <div className="card-brand">
            <div className="card-tagline">A home for Nepali creators</div>
          </div>

          <div className="panel">
            <div className="panel-heading">Welcome back</div>
            <div className="panel-sub">Sign in to continue to your account</div>
            ...
            <div className="value-strip">
              <p>Discover creators you love and support their work monthly — no middlemen, no friction.</p>
            </div>
            ...
            <div className="social-proof-mini">
              ...
              <span className="social-proof-text">Trusted by early supporters in Nepal</span>
            </div>
          </div>
