      ...
      <div className="left">
        ...
        <div className="left-mid">
          ...
          <h1 className="headline">
            Join <span className="accent">HamroBhet</span>
          </h1>
          <p className="description">
            Support and discover Nepali creators you love — artists, educators, musicians, and developers, all in one place.
          </p>
